...
- Un même plat peut être préparé en quantité pour 2 jours si pratique
...
Le batch cooking = préparer un plat le soir pour le(s) déjeuner(s) du lendemain ou surlendemain. Les déjeuners sont emportés en tupperware et réchauffés.
1. Chaque déjeuner en semaine (lun-ven) est un plat préparé la veille au soir ou le dimanche soir.
2. Un même plat peut servir 1 ou 2 déjeuners selon les quantités. Pas obligé de le transformer le jour 2.
3. La préparation du soir est indiquée dans le champ "cooking.prep" du jour précédent.
4. Quantités de viande : minimum 450-600g par batch pour 2 personnes.
...
EXEMPLE DE SEMAINE CORRECTE :
- Lun déj : chili con carne (batch, VIANDE) | Lun dîn : omelette champignons-gruyère (VÉGÉ)
- Mar déj : burritos au chili (batch J2, viande d'accompagnement) | Mar dîn : pavé de saumon teriyaki (POISSON)
- Mer déj : dhal lentilles corail (batch, VÉGÉ) | Mer dîn : croque-madame (VÉGÉ + jambon accompagnement)
- Jeu déj : naan garni au dhal (batch J2, VÉGÉ) | Jeu dîn : côte de porc moutarde (VIANDE)
- Ven déj : risotto champignons-parmesan (VÉGÉ) | Ven dîn : filet de cabillaud croûte d'herbes (POISSON)
- Sam déj : burger maison (VIANDE) | Sam dîn : carbonara guanciale (VÉGÉ + accompagnement)
- Dim déj : poulet rôti purée (VIANDE) | Dim dîn : tortilla espagnole (VÉGÉ)
→ Viande : 4 | Poisson : 2 | Végé/accompagnement : 8 ✓

ERREUR TYPE À NE PAS REPRODUIRE :
- Lun : tajine agneau | Mar : naan curry agneau | Mer : curry agneau | Jeu : côte de porc
→ C'est 3 jours d'agneau + viande tous les jours = REJETÉ. L'agneau ne peut apparaître que 2 jours max (batch).
