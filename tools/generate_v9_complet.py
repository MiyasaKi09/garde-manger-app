...
COMPLETE_MAPPING = {
    ...
    'sucre glace': ('sucre glace', 'archetype', 14, 'Sucre broyé finement'),
    ...
    'girofle': ('girofle', 'archetype', 10, 'Bouton de fleur séché'),
    ...
    'nuoc mam': ('nuoc mam', 'archetype', 14, 'Sauce poisson fermentée'),
    'nuoc-mâm': ('nuoc mam', 'archetype', 14, 'Sauce poisson fermentée'),
    ...
    'blancs de poulet': ('blanc de poulet', 'canonical', 9, 'Partie naturelle'),
    'blanc de poulet': ('blanc de poulet', 'canonical', 9, 'Partie naturelle'),
    ...
    'pruneaux': ('pruneau', 'archetype', 1, 'Fruit séché (déshydratation)'),
    'pruneau': ('pruneau', 'archetype', 1, 'Prune séchée'),
    'pruneaux dénoyautés': ('pruneau', 'archetype', 1, 'Retirer dénoyauté'),
    ...
    # === VINS ET ALCOOLS ===
    'vin blanc': ('vin blanc', 'archetype', 14, 'Boisson fermentée'),
    'vin blanc sec': ('vin blanc', 'archetype', 14, 'Adjectif inutile'),
    'vin rouge': ('vin rouge', 'archetype', 14, 'Boisson fermentée'),
    'vin rouge de Bourgogne': ('vin rouge', 'archetype', 14, 'Origine inutile'),
    'xérès': ('xérès', 'archetype', 14, 'Vin fortifié'),
    'sherry': ('xérès', 'archetype', 14, 'Synonyme anglais'),
    'madère': ('madère', 'archetype', 14, 'Vin fortifié'),
    'cognac': ('cognac', 'archetype', 14, 'Eau-de-vie distillée'),
    'calvados': ('calvados', 'archetype', 14, 'Eau-de-vie distillée'),
    'rhum': ('rhum', 'archetype', 14, 'Alcool distillé'),
    'rhum ambré': ('rhum', 'archetype', 14, 'Type inutile'),
    'amaretto': ('amaretto', 'archetype', 14, 'Liqueur distillée'),
    'cidre brut': ('cidre', 'archetype', 14, 'Boisson fermentée'),
    'bière ambrée': ('bière', 'archetype', 14, 'Type inutile'),
    
    # === SIROPS ===
    'sirop d\'érable': ('sirop d\'érable', 'canonical', 14, 'Sève concentrée'),
    'sirop d\'agave': ('sirop d\'agave', 'archetype', 14, 'Sève concentrée et cuite'),
    ...
    'café fort': ('café', 'archetype', 14, 'Force inutile'),
    'café': ('café', 'archetype', 14, 'Grain torréfié et moulu'),
    ...
    'raisins secs': ('raisin sec', 'archetype', 1, 'Fruit séché'),
    'raisin sec': ('raisin sec', 'archetype', 1, 'Fruit séché'),
    'abricots secs': ('abricot sec', 'archetype', 1, 'Fruit séché'),
    'abricot sec': ('abricot sec', 'archetype', 1, 'Fruit séché'),
    ...
    'clou de girofle': ('girofle', 'archetype', 10, 'Bouton de fleur séché'),
    ...
    'chocolat noir': ('chocolat noir', 'archetype', 14, 'Fève torréfiée et transformée'),
    'pépites de chocolat': ('pépite de chocolat', 'archetype', 14, 'Chocolat solidifié'),
    'pépites chocolat': ('pépite de chocolat', 'archetype', 14, 'Chocolat solidifié'),
    'pépite de chocolat': ('pépite de chocolat', 'archetype', 14, 'Chocolat solidifié'),
    'ganache chocolat': ('ganache chocolat', 'archetype', 14, 'Préparation'),
    'mirin': ('mirin', 'archetype', 14, 'Vin de riz doux fermenté'),
    'saké': ('saké', 'archetype', 14, 'Alcool de riz fermenté'),
