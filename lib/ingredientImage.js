...
const MAP = [
  ...
  ['epinard', 'Spinach'], ['laitue', 'Lettuce'], ['salade', 'Lettuce'], ['roquette', 'arugula leaves'], ['mache', 'green salad leaves'],
  ...
  // Crémerie & œufs
  ['parmesan', 'parmesan cheese block'], ['mozzarella', 'mozzarella cheese'], ['feta', 'feta cheese'], ['mascarpone', 'mascarpone cheese'],
  ['ricotta', 'Ricotta'], ['comte', 'Cheese'], ['gruyere', 'Cheese'], ['emmental', 'Cheese'], ['cheddar', 'Cheddar Cheese'],
  ['chevre', 'goat cheese log'], ['fromage', 'Cheese'], ['beurre', 'Butter'], ['creme', 'sour cream'],
  ...
  // Herbes & épices
  ['basilic', 'fresh basil leaves'], ['persil', 'parsley herb'], ['coriandre', 'coriander herb'], ['menthe', 'mint leaves'],
