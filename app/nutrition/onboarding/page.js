...
const styles = {
  ...
  input: { width: '100%', padding: '10px 12px', border: '1px solid rgba(0,0,0,0.08)', borderRadius: 10, fontSize: 15, fontFamily: 'inherit', background: 'var(--surface)', color: '#1f2937', boxSizing: 'border-box' },
  ...
  rateBtn: { flex: 1, padding: '12px 8px', border: '1px solid rgba(0,0,0,0.08)', borderRadius: 10, background: 'var(--surface)', cursor: 'pointer', fontFamily: 'inherit', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2, fontSize: 16, color: '#374151' },
  ...
  activityBtn: { padding: '14px 16px', border: '1px solid rgba(0,0,0,0.08)', borderRadius: 12, background: 'var(--surface)', cursor: 'pointer', fontFamily: 'inherit', fontSize: 14, textAlign: 'left', color: '#374151', transition: 'all 0.15s' },
