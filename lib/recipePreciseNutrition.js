  ...
  try {
    ...
    if (Array.isArray(nutritionData)) {
      for (const row of nutritionData) {
        ...
        else if (name.includes('protéine') || name.includes('proteine')) nutrition.protein_g = Math.round((row.value_per_serving || 0) * 10) / 10
        else if (name.includes('glucide')) nutrition.carbs_g = Math.round((row.value_per_serving || 0) * 10) / 10
        else if (name.includes('lipide')) nutrition.fat_g = Math.round((row.value_per_serving || 0) * 10) / 10
        else if (name.includes('fibre')) nutrition.fiber_g = Math.round((row.value_per_serving || 0) * 10) / 10
        else nutrition[name] = Math.round((row.value_per_serving || 0) * 100) / 100 // micros : 2 décimales
      }
    }
