-- ============================================================================
-- Rollback P4 — restaure publish_canonical_closed_loop_plan sans l'exemption
-- des créneaux « support » (revient au garde-fou du 20260717000001).
-- ATTENTION : après ce rollback, publier un plan contenant des créneaux
-- support (source='support') lèvera de nouveau recipe_execution_mapping_incomplete.
-- ============================================================================
