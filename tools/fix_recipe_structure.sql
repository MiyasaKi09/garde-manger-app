...
-- ========================================================================
-- Objectifs:
-- 1. Ajouter le rôle SAUCE
-- 2. Ajouter la colonne is_complete_meal
-- 3. Importer les sauces classiques
-- 4. Catégoriser les recettes existantes
-- ========================================================================

-- ========================================================================
-- 1. AJOUTER LE RÔLE SAUCE À L'ENUM
-- ========================================================================
-- IMPORTANT: L'ajout d'une valeur ENUM ne peut PAS être dans une transaction
-- Il doit être COMMIT immédiatement avant d'être utilisé

-- Ajouter SAUCE au type recipe_role_enum (le vrai nom de l'enum)
ALTER TYPE recipe_role_enum ADD VALUE IF NOT EXISTS 'SAUCE';

-- Maintenant on peut commencer la transaction pour le reste
BEGIN;
...
-- ========================================================================
-- 3. AJOUTER LA COLONNE needs_side_dish
-- ========================================================================
...
-- ========================================================================
-- 4. IMPORTER LES SAUCES CLASSIQUES FRANÇAISES
-- ========================================================================
...
-- ========================================================================
-- 5. AJOUTER DES RECETTES DE BASES (BOUILLONS, FONDS)
-- ========================================================================
...
-- ========================================================================
-- 6. CATÉGORISER LES PLATS COMPLETS EXISTANTS
-- ========================================================================
