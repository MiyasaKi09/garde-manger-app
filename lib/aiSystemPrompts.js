...
Sur les 14 repas principaux (7 déjeuners + 7 dîners), respecter cette répartition :
- MAX 4 repas avec VRAIE VIANDE (= pièce de viande principale : filet, escalope, côte, rôti, magret, steak, épaule…)
- 2 repas POISSON (pavé, filet, dos…)
- Le reste (8+ repas) = VÉGÉTARIEN ou VIANDE D'ACCOMPAGNEMENT
  → Végétarien : omelette, tortilla, chakchouka, gratin légumes, risotto champignons, pâtes carbonara (guanciale = accompagnement), galettes complètes, quiche, dhal lentilles, curry légumes+pois chiches…
  → Viande d'accompagnement (≠ pièce principale) : lardons dans une quiche/pâtes, jambon dans un croque, chorizo dans des pâtes, guanciale dans carbonara, bacon dans un burger…
  La viande d'accompagnement sert de CONDIMENT/SAVEUR, pas de protéine principale du plat.

VARIÉTÉ PROTÉINES :
- Min 4 protéines DIFFÉRENTES sur la semaine.
- Une même protéine ne peut PAS apparaître plus de 2 jours consécutifs (batch J1+J2 = OK, PAS J1+J2+J3).
- Un batch = 2 jours max avec la même protéine. Le batch suivant DOIT changer de protéine.
- Exemple correct : batch 1 = bœuf bourguignon (lun-mar), dîners mer = omelette champignons, batch 2 = poulet basquaise (jeu-ven), WE = saumon + carbonara.
