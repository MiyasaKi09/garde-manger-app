...
function evaluateCandidate(state, recipe, slot, constraints, targets, context, scale = 1, engage = null) {
  ...
  // vivier d'aujourd'hui, 57,6 % de plats français après normalisation des
  // libellés, un plafond de cuisine à 40 % comme REFUS n'a mathématiquement
  // aucune semaine à proposer : quatorze créneaux, cinq français au plus, et
  // rien de comparable pour occuper les neuf autres. Armer les plafonds
  // aujourd'hui produirait `no_feasible_plan`, c'est-à-dire aucune semaine du
  // tout, ce qui est pire que la semaine trop française d'aujourd'hui.
  //
