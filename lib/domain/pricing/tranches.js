...
import legumineuses from '@/data/prices/tranches/legumineuses.json'
import carne from '@/data/prices/tranches/carne.json'
import aromates from '@/data/prices/tranches/aromates.json'
import legumesFruits from '@/data/prices/tranches/legumes-fruits.json'
import merTransformes from '@/data/prices/tranches/mer-transformes.json'
import liquidesDivers from '@/data/prices/tranches/liquides-divers.json'
import surgeles from '@/data/prices/tranches/surgeles.json'
...
export const TRANCHES = Object.freeze(
  [
    assaisonnement, epicerie, fraisAnimal, fraisVegetal,
    carne, legumineuses, aromates, legumesFruits, merTransformes, liquidesDivers,
    surgeles,
  ].filter(
