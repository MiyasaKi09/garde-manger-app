...
-- épinard frais (utilisé 2x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('épinard frais', 2, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- amande effilée (utilisé 2x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- pousse de soja (utilisé 2x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('pousse de soja', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- galette de riz (utilisé 2x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- fruit rouges mélangé (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- cerneal de noix (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('cerneal de noix', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- saucisse porc (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('saucisse porc', 9, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- muffin anglais (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- fécule de maï (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('fécule de maï', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- pimiento de Padrón (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- pois chiches sec (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('pois chiches sec', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- feuille de brick (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('feuille de brick', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- champignon noir (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- artichaut violets moyen (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- jaune d'œuf (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('jaune d''œuf', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- haricot blancs sec (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('haricot blancs sec', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- pâte courte (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
VALUES ('pâte courte', 14, NOW(), NOW())
ON CONFLICT (canonical_name) DO NOTHING;

-- saucisse de Strasbourg (utilisé 1x)
INSERT INTO canonical_foods (canonical_name, category_id, created_at, updated_at)
...
-- =====================================================
-- Ces ingrédients doivent être créés comme recettes
-- et liés via sub_recipe_id dans recipe_ingredients

-- TODO MANUEL: Créer la recette 'bouillon de boeuf' (utilisé 5x)
-- INSERT INTO recipes (name, ...) VALUES ('bouillon de boeuf', ...);

-- TODO MANUEL: Créer la recette 'pâte feuilletée' (utilisé 4x)
-- INSERT INTO recipes (name, ...) VALUES ('pâte feuilletée', ...);

-- TODO MANUEL: Créer la recette 'bouillon de légume' (utilisé 2x)
-- INSERT INTO recipes (name, ...) VALUES ('bouillon de légume', ...);

-- TODO MANUEL: Créer la recette 'sauce tomate' (utilisé 2x)
-- INSERT INTO recipes (name, ...) VALUES ('sauce tomate', ...);

-- TODO MANUEL: Créer la recette 'haricot blancs sauce tomate' (utilisé 1x)
-- INSERT INTO recipes (name, ...) VALUES ('haricot blancs sauce tomate', ...);

-- TODO MANUEL: Créer la recette 'pâte brisée' (utilisé 1x)
-- INSERT INTO recipes (name, ...) VALUES ('pâte brisée', ...);

-- TODO MANUEL: Créer la recette 'pâte à pizza' (utilisé 1x)
-- INSERT INTO recipes (name, ...) VALUES ('pâte à pizza', ...);

-- TODO MANUEL: Créer la recette 'confit de canard' (utilisé 1x)
-- INSERT INTO recipes (name, ...) VALUES ('confit de canard', ...);

-- TODO MANUEL: Créer la recette 'ganache ou crème' (utilisé 1x)
-- INSERT INTO recipes (name, ...) VALUES ('ganache ou crème', ...);

-- TODO MANUEL: Créer la recette 'sucre pour caramel' (utilisé 1x)
-- INSERT INTO recipes (name, ...) VALUES ('sucre pour caramel', ...);

-- TODO MANUEL: Créer la recette 'ganache chocolat' (utilisé 1x)
-- INSERT INTO recipes (name, ...) VALUES ('ganache chocolat', ...);


COMMIT;

-- Total: 260 canonical_foods + 52 archetypes
-- + 11 sous-recettes à créer manuellement
